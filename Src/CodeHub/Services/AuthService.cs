...
namespace CodeHub.Services
{
    class AuthService
    {
        ...
        Uri endUri = new Uri("https://example.com/path");
        #endregion
        ...
        public async Task<bool> Authenticate()
        {
            try
            {
                ...
                EdgeAuth.WebAuthenticationResult WebAuthenticationResult = 
                await EdgeAuth.WebAuthenticationBroker.AuthenticateAsync(
                ...
                if (WebAuthenticationResult.ResponseStatus == EdgeAuth.WebAuthenticationStatus.Success)
                {
                    ...
                    bool result = await Authorize(response);
